...
doc = TeiReader(source_tei)
items = doc.any_xpath('.//tei:bibl[@type="sk"]/tei:title[@level="j" and not(parent::tei:bibl/tei:title[not(@level="j")][2]) and not(parent::tei:bibl/date) and not(parent::tei:bibl/tei:num)]')
nsmap = doc.nsmap
print(len(items))
for x in items:
